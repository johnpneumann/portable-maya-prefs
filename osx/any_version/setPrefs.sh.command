...
echo "\n"
echo "Local drives that are available, that your preferences may be retrieved from."
...
cp -v -r ./$mayaVersion ~/Library/Preferences/Autodesk/maya/
...
diff -qr ./$mayaVersion/ ~/Library/Preferences/Autodesk/maya/$mayaVersion/
