...
:get the users input for the version of maya they're using
:versionCheck
echo What version of maya are you using?
set mayaVersion=
set /P mayaVersion=Version Number:
if "%mayaVersion%"=="" goto versionCheck
...
echo Choose D for directory when prompted
%systemroot%\system32\xcopy.exe /S /R /Y /C /V "%userprofile%\%docLoc%\maya\%mayaVersion%" .\%mayaVersion%
